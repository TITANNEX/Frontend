  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to TITANNEX.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
            ...
            <Text mb={3}>
              <LiquidityLink href="https://exchange.titannexswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
